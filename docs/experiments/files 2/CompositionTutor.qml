...
MuseScore {
    ...
    Component.onCompleted: {
        ...
        console.log("Current question:", currentQuestion ? currentQuestion.id : "NULL")
        console.log("Question text:", currentQuestion ? currentQuestion.text : "NULL")
    }
        ...
        ColumnLayout {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    color: optionMouseArea.containsMouse ? midlightColor : buttonColor
                    border.color: "#4a4a4a"
                    border.width: 1
                    radius: 6
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    Layout.fillWidth: true
                    Layout.preferredHeight: 60
                    color: linkMouseArea.containsMouse ? midlightColor : buttonColor
                    border.color: "#4a9eff"
                    border.width: 1
                    radius: 4
